  ...
  return (
    <div className='flex flex-col items-center gap-5'>
        <div className='w-full rounded-xl h-fit md:h-72 flex items-center justify-center bg-gray-primary'>
            ...
            <img src={props.tableImageUrl} className='h-full hidden md:block lg:hidden w-auto md:object-cover mx-auto rounded-xl'/>
            <img src={props.mobileImageUrl} className='hidden lg:block h-full w-auto md:object-cover mx-auto rounded-xl'/>
        </div>
